...
public class ChronicleProvider implements DistributionProvider {

    private static final String TCP_CONFIG_TYPE = "aries.chronicle";
    ...
    public Endpoint exportService(Object serviceO, 
        ...
        return new ChronicleEndpoint(serviceO, effectiveProperties);
    }
